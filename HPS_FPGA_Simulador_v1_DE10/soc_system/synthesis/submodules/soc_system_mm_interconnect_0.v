...
module soc_system_mm_interconnect_0 (
	...
	wire  [126:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> hps_0_h2f_lw_axi_master_agent:write_rp_data
	wire          rsp_mux_src_ready;                                                          // hps_0_h2f_lw_axi_master_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> hps_0_h2f_lw_axi_master_agent:write_rp_channel
	...
	wire  [126:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> hps_0_h2f_lw_axi_master_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                                                      // hps_0_h2f_lw_axi_master_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [5:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> hps_0_h2f_lw_axi_master_agent:read_rp_channel
	...
	wire  [126:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> ILC_avalon_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                      // ILC_avalon_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> ILC_avalon_slave_agent:cp_channel
	...
	wire  [126:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> button_pio_s1_agent:cp_data
	...
	wire  [126:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> dipsw_pio_s1_agent:cp_data
	...
	wire          ilc_avalon_slave_agent_rp_valid;                                            // ILC_avalon_slave_agent:rp_valid -> router_005:sink_valid
	wire  [126:0] ilc_avalon_slave_agent_rp_data;                                             // ILC_avalon_slave_agent:rp_data -> router_005:sink_data
	wire          ilc_avalon_slave_agent_rp_ready;                                            // router_005:sink_ready -> ILC_avalon_slave_agent:rp_ready
	wire          ilc_avalon_slave_agent_rp_startofpacket;                                    // ILC_avalon_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          ilc_avalon_slave_agent_rp_endofpacket;                                      // ILC_avalon_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [126:0] button_pio_s1_agent_rp_data;                                                // button_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire    [5:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> led_pio_s1_burst_adapter:sink0_channel
